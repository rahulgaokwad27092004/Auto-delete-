...
BOT_TOKEN = "YOUR_BOT_TOKEN"  # Replace with your real token (and regenerate if it was leaked)
WEBHOOK_URL = "https://auto-delete.koyeb.app"  # ✅ Replace with your actual Koyeb app URL
